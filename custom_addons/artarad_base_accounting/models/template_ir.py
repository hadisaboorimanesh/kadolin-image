...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_ir_template_data(self):
        ...
        """
        return {
            "property_account_receivable_id": "account_account_template_14",
            "property_account_payable_id": "account_account_template_69",
            "property_account_expense_categ_id": "account_account_template_109",
            "property_account_income_categ_id": "account_account_template_104",
        }
    ...
    def _get_ir_res_company(self):
        ...
        return {
            self.env.company.id: {
                ...
                "account_default_pos_receivable_account_id": "account_account_template_14",
            }
        }
