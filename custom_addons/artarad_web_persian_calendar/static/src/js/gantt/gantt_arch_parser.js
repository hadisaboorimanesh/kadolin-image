...
const jSCALES = {
    day: {
        ...
        // determines column groups
        unit: "day",
        groupHeaderFormatter: (date) => date.toFormat("jdd jMMMM jyyyy"),
    ...
    week: {
        ...
        interval: "day",
        minimalColumnWidth: 192,
        colHeaderFormatter: (date) => date.toFormat("jdd"),
    ...
    month: {
        ...
        unit: "jmonth",
        groupHeaderFormatter: (date, env) => date.toFormat(env.isSmall ? "jMMM jyyyy" : "jMMMM jyyyy"),

        defaultRange: { unit: "jmonth", count: 3 },
    },
    month_3: {
        cellPrecisions: { full: 24, half: 12 },
        defaultPrecision: "half",
        ...
        defaultRange: { unit: "jmonth", count: 6 },
    },
    year: {
        cellPrecisions: { full: 1 },
        defaultPrecision: "full",
        ...
        interval: "jmonth",
        minimalColumnWidth: 60,
        colHeaderFormatter: (date, env) => date.toFormat(env.isSmall ? "jMMM" : "jMMMM"),

        unit: "jyear",
        groupHeaderFormatter: (date) => date.toFormat("jyyyy"),

        defaultRange: { unit: "jyear", count: 1 },
    },
};

const SCALES = odoo.user_calendar_type === "jalaali" ? jSCALES : gSCALES;
...
GanttArchParser.prototype.parse = function(arch) {
